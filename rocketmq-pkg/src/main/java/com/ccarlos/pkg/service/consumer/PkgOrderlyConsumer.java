package com.ccarlos.pkg.service.consumer;
...
import com.ccarlos.pkg.utils.FastJsonConvertUtil;
        ...
        public ConsumeOrderlyStatus consumeMessage(List<MessageExt> msgs, ConsumeOrderlyContext context) {
            ...
            for (MessageExt msg : msgs) {
                try {
                    ...
                    System.err.println("收到消息：" + "  topic :" + topic +
                            "  ,tags : " + tags + "keys :" + keys + ", msg : " + msgBody);

                    Map<String, Object> body = FastJsonConvertUtil.convertJSONToObject
                            (msgBody, Map.class);
